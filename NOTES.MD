...
Content-Type: MIME (Multipurpose Internet Mail Extensions) type of the content of the body to be rendered  (text/html, text/plain, image/gif, multipart/form-data)
