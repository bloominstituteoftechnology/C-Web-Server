...
void handle_http_request(int fd)
{
    ...
    // Hint: sscanf()!
    // sscanf takes a source string, icks out a specifc format, and put them into specificed vaiables
       ...
       if (strcmp(request_type, "GET") == 0)// check to see if endpoints match
       {
