...
void get_root(int fd) {
  ...
  sprintf(response_body,
          "<!DOCTYPE html><html><body><h1>Hello World!</h1><p "
          "class=\"invalid\">More stuff</p></body></html>");
...
void get_d20(int fd) {
  ...
  sprintf(
      response_body,
      "<!DOCTYPE html><html><body><h1>Hello World!</h1><p>%d</p></body></html>",
      random);
