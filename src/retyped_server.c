...
#include <stdlib.h> // malloc(), exit() comes from here
#include <unistd.h> // variables and constants - part of POSIX header
#include <errno.h> // error codes in linux - part of POSIX library
#include <string.h> // manipulating string (array of char)
#include <sys/types.h> // various data types - part of POISX header
...
#include <sys/wait.h> // terminated child process status - part of POSIX header
#include <signal.h> //	Signals, see C signal handling
#include <time.h> // Type-Generic Macros, see C date and time functions
#include <sys/file.h>
#include <fcntl.h> // open files, lock, etc - part of POSIX header
